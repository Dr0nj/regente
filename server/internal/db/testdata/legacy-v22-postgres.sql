CREATE TABLE schema_migrations(version INTEGER PRIMARY KEY, applied_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP);
...
ALTER TABLE instances ADD COLUMN carried_at TIMESTAMPTZ;
...
ALTER TABLE agents ADD COLUMN connected_at TIMESTAMPTZ;
ALTER TABLE agents ADD COLUMN first_seen TIMESTAMPTZ;
...
ALTER TABLE daily_runs ADD COLUMN report_sent_at TIMESTAMPTZ;
