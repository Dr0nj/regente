...
| ✅ | ~~**Fase Z (artefatos)** — case study + post LinkedIn~~ | **Feito (2026-07-13):** `docs/case-study.md` + `docs/linkedin-post.md`. Resta SÓ a publicação manual (ver §🏁 Fase Z no Backlog). |
