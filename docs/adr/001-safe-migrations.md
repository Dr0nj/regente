...
Historical I02 contract (2026-09-11): schemas 0–23 could upgrade to schema 24;
that statement is not the current binary's supported range. The
[current runtime contract](../integration-baseline.md#current-runtime-schema-contract)
is checked against code, and the [compatibility matrix](../upgrades.md) defines
the evidence and rollout limits. I02 retired legacy secrets and required explicit
reissue; see [the identity upgrade procedure](../agent-identity.md). Future
